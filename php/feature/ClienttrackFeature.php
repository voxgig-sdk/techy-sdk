...
class TechyClienttrackFeature extends TechyBaseFeature
{
    ...
    public function PostConstruct(TechyContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Techy-SDK';
