...
class TechyStreamingFeature extends TechyBaseFeature
{
    ...
    private function _iterate(TechyResult $result): \Generator
    {
    ...
    private function _streamable(TechyContext $ctx): bool
    {
