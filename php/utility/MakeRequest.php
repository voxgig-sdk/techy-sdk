...
// Techy SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class TechyMakeRequest
{
    public static function call(TechyContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new TechyResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new TechyResponse($fetched);
        } else {
