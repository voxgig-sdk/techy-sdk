...
// Techy SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (TechySDK::test)
...
{
    private const SDK_CLASS = 'TechySDK';
    ...
    private const SDK_BASE = 'techy_sdk';
