...
class TechyTestRunner
{
    ...
    {
        $live = self::getenv('TECHY_TEST_LIVE');
        $override = self::getenv('TECHY_TEST_OVERRIDE');
        ...
        $explain = self::getenv('TECHY_TEST_EXPLAIN');
...
class_alias('TechyTestRunner', 'Runner');
class_alias('TechyHelpers', 'Helpers');
