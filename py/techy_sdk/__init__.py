...
from techy_sdk.utility import register

# Load features
from techy_sdk.feature.base_feature import TechyBaseFeature
from techy_sdk.features import _has_feature, _make_feature
...
class TechySDK:
    ...
    def get_utility(self):
        return TechyUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("TechySDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Phrase(self, data=None) -> "PhraseEntity":
        ...
        from techy_sdk.entity.phrase_entity import PhraseEntity
