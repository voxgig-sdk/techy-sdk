...
from techy_sdk.core.helpers import get_ctx_prop, to_map
...
class TechyContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(rp, TechyResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return TechyError(code, msg, self)
