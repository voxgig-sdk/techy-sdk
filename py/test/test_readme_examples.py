# Techy SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions TechySDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both TechySDK(...) and TechySDK.test(...) become
#      TechySDK.test({"entity": {...}}) seeding one mock record (id "test01")
