# Techy TypeScript SDK



The TypeScript SDK for the Techy API — a type-safe, entity-oriented client with full async/await support.

The API is exposed as capitalised, semantic **Entities** — e.g.
`client.Phrase()` — each with a small set of operations (`load`)
...
const phrase = await client.Phrase().load()
// phrase is a bare entity populated with mock response data
console.log(phrase)
```
...
| Method | Returns | Description |
| --- | --- | --- |
| `TechySDK.test(testopts?, sdkopts?)` | `TechySDK` | Create a test-mode client. |
...
| `client` | `client(): TechySDK` | Return the parent SDK client. |
