...
describe('PhrasDirect', async () => {
  ...
  test('direct-load-phras', async (t: any) => {
    const setup = directSetup({ id: 'direct01' })
    if (maybeSkipControl(t, 'direct', 'direct-load-phras', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['TECHY_TEST_PHRAS_ENTID']
