...
(0, node_test_1.describe)('PhraseDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-phrase', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-phrase', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.TechySDK(Object.assign({}, (0, utility_1.liveClientOptions)(), {}));
        let idmap = env['TECHY_TEST_PHRASE_ENTID'];
...
//# sourceMappingURL=PhraseDirect.test.js.map