...
|---|---|---|
| `ts/` | @voxgig-sdk/techy-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/techy-sdk \
      --repository voxgig-sdk/techy-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/techy-sdk` shows it, and
`npm trust revoke @voxgig-sdk/techy-sdk --id=<id>` removes it.
