...
class TechyTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = TechyTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = TechyTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = TechyTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
