...
class TechyTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = TechyTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = TechyTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = TechyTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
