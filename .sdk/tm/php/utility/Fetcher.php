...
class TechyFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; TechySDK/1.0)';
    ...
    public static function call(TechyContext $ctx, string $fullurl, array $fetchdef): array
    {
