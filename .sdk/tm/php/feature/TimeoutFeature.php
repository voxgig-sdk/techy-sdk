...
class TechyTimeoutFeature extends TechyBaseFeature
{
    ...
    private function _with_timeout(TechyContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(TechyContext $_ctx, float $ms): void
    {
        $client = $this->client;
