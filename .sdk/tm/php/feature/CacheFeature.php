...
class TechyCacheFeature extends TechyBaseFeature
{
    ...
    private function _through(TechyContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
