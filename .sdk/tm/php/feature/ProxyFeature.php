...
class TechyProxyFeature extends TechyBaseFeature
{
    ...
    public function init(TechyContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (TechyContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
