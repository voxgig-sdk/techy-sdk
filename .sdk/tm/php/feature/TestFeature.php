...
// Techy SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class TechyTestFeature extends TechyBaseFeature
{
    ...
    public function init(TechyContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (TechyContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (TechyContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(TechyContext $ctx, $op, $args): array
    {
