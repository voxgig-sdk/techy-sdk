...
class TechyRbacFeature extends TechyBaseFeature
{
    ...
    private function _required(TechyContext $ctx): ?string
    {
    ...
    private function _reject(TechyContext $ctx, string $required): void
    {
    ...
    private function _track(TechyContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
