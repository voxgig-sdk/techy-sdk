...
class TechyRatelimitFeature extends TechyBaseFeature
{
    ...
    private function _acquire(TechyContext $ctx): void
    {
    ...
    private function _track(TechyContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
