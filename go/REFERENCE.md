# Techy Golang SDK Reference

Complete API reference for the Techy Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *TechySDK`
...
fmt.Println(phrase.GetName()) // "phrase"
```
