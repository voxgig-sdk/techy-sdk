...
type PhraseEntity struct {
	name    string
	client  *core.TechySDK
...
func NewPhraseEntity(client *core.TechySDK, entopts map[string]any) *PhraseEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PhraseEntity) GetName() string { return e.name }
...
func (e *PhraseEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PhraseEntity) Deleted() bool {
	return e.deleted
}


func (e *PhraseEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPhraseEntity(e.client, opts)
}

func (e *PhraseEntity) Data(args ...any) any {
...
func (e *PhraseEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Phrase; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *PhraseEntity) DataTyped(data ...Phrase) Phrase {
	if len(data) > 0 {
		return typedFrom[Phrase](e.Data(asMap(data[0])))
	}
	return typedFrom[Phrase](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Phrase (all fields
// optional at the wire level).
func (e *PhraseEntity) MatchTyped(match ...Phrase) Phrase {
	if len(match) > 0 {
		return typedFrom[Phrase](e.Match(asMap(match[0])))
	}
	return typedFrom[Phrase](e.Match())
}
...
func (e *PhraseEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PhraseEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// PhraseLoadMatch and returns an Phrase. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *PhraseEntity) LoadTyped(reqmatch PhraseLoadMatch, ctrl map[string]any) (Phrase, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Phrase{}, err
	}
	return typedFrom[Phrase](res), nil
}



func (e *PhraseEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *PhraseEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *PhraseEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *PhraseEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *PhraseEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
