...
func (sdk *TechySDK) OptionsMap() map[string]any {
...
func (sdk *TechySDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *TechySDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *TechySDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *TechySDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *TechySDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *TechySDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("TechySDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *TechySDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *TechySDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("TechySDK: graphql: %s", msg)
		res["graphql"] = errors
	}
