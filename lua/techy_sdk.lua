...
TechySDK._make_feature = _make_feature


function TechySDK.new(options)
  local self = setmetatable({}, TechySDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function TechySDK:get_utility()
  return Utility.copy(self._utility)
end


function TechySDK:get_root_ctx()
  return self._rootctx
end


function TechySDK:prepare(fetchargs)
...
function TechySDK:direct(fetchargs)
...
-- by passing it.
function TechySDK:_raw_request(fetchargs)
  local utility = self._utility
...
function TechySDK:graphql(query, variables, ctrl)
...
function TechySDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = TechySDK.new(sdkopts)
  sdk.mode = "test"
