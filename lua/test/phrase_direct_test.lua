...
describe("PhraseDirect", function()
  it("should direct-load-phrase", function()
    local setup = phrase_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-phrase", setup.live and "live" or "unit")
