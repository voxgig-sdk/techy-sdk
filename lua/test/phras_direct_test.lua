...
describe("PhrasDirect", function()
  it("should direct-load-phras", function()
    local setup = phras_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-phras", setup.live and "live" or "unit")
