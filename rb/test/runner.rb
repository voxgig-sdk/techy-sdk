...
module TechyTestRunner
  ...
  def self.env_override(m)
    live = getenv("TECHY_TEST_LIVE")
    override = getenv("TECHY_TEST_OVERRIDE")
    ...
    explain = getenv("TECHY_TEST_EXPLAIN")
    m["TECHY_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = TechyTestRunner
Helpers = TechyHelpers
Vs = VoxgigStruct
