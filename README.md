...
Learn more about Techy at [techy-api.vercel.app](https://techy-api.vercel.app).

This is an unofficial SDK for the Techy public API, generated by Voxgig with [`@voxgig/sdkgen`](https://github.com/voxgig/sdkgen). It is not affiliated with, endorsed by, or sponsored by the upstream API provider.
...
This SDK exposes the API as a small set of **semantic entities** — Phrase — that you
...
| Ruby | `voxgig-sdk-techy` | publish pending — [install from git tag](https://github.com/voxgig-sdk/techy-sdk/releases) |
| Lua | `voxgig-sdk-techy` | publish pending — [install from git tag](https://github.com/voxgig-sdk/techy-sdk/releases) |
| Go CLI | `github.com/voxgig-sdk/techy-sdk/go-cli` | `go install github.com/voxgig-sdk/techy-sdk/go-cli/cmd/techy@latest` |
| Go MCP server | `github.com/voxgig-sdk/techy-sdk/go-mcp` | `go get github.com/voxgig-sdk/techy-sdk/go-mcp@latest` |
...
| --- | --- | --- |
| **Phrase** | The Phrase entity (load). | `/api/json` |
