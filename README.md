...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/techy` | `npm install @voxgig-sdk/techy` |
| Python | `voxgig-sdk-techy` | `pip install voxgig-sdk-techy` |
| PHP | `voxgig-sdk/techy` | `composer require voxgig-sdk/techy` |
| Golang | `github.com/voxgig-sdk/techy-sdk/go` | `go get github.com/voxgig-sdk/techy-sdk/go` |
| Ruby | `voxgig-sdk-techy` | `gem install voxgig-sdk-techy` |
| Lua | `voxgig-sdk-techy` | `luarocks install voxgig-sdk-techy` |
