...
type Args struct {
	Entity string         `json:"entity" jsonschema:"phrase"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.TechySDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "techy_list",
		Description: "List records from Techy. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "techy_load",
		Description: "Load a single record from Techy. " +
...
func runOp(client *sdk.TechySDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.TechySDK, name string) (sdk.TechyEntity, error) {
	switch strings.ToLower(name) {
	case "phrase":
		return client.Phrase(nil), nil
